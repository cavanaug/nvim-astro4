...
-- opt.backupdir = ".bkp/," .. vim.fn.stdpath("state") .. "/backup/"
...
opt.verbose = 0
-- opt.verbosefile = vim.env.HOME .. "/.local/state/nvim/verbose.log"
opt.verbosefile = vim.fn.stdpath("state") .. "/verbose.log"
